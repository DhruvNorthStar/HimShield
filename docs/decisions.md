...
Script: `python -m src.clean_gsi`. Output: `data/shapefiles/landslides.gpkg`, **5,070 points**, EPSG:32644.
...
- **Coarse coordinates dropped.** A longitude with one decimal is precise to about 10 km; at a 30 m grid
  it samples an unrelated slope.

Limitations to state in the report:
- 45 kept points have a 2-decimal longitude (about 1 km).
- 7 kept points have a 0 or 1 decimal latitude (the removal rule was set on longitude).
